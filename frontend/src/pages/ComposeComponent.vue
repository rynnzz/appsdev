    ...
    <q-page-container>
      ...
      <q-page class="body">
        ...
        <div align="center">
          ...
          <q-btn @click="postContent" color="blue" style="margin: 30px; width: 140px; font-family: 'Product Sans Black', sans-serif;">
            <i class="mx-2">
      ...
      <q-dialog v-model="showDialog">
        <div style="background: #121212; width: 400px; max-width: 80vw;" class="compose-dialog">
          <q-card-section>
          ...
          <div class="footer" style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
            <q-btn type="button" @click="showDialog = false" style="margin-right: 10px; border-radius: 20px; padding: 6px 12px; background: rgb(31, 32, 35); border: 1px solid rgb(60, 63, 68); color: rgb(247, 248, 248); appearance: none; transition: border 0.15s ease 0s; width: 150px; align-items: center; font-family: 'Product Sans medium', sans-serif;">CLOSE</q-btn>
          </div>
        </div>
      </q-dialog>
    </q-layout>
...
export default {
  data() {
    return {
      ...
      notificationCount: 0, // New property to track notification count
      selectedDay: '',
      selectedMonth: '',
      selectedYear: '',
  ...
  methods: {
    setActiveTab(ComposeComponent) {
      this.activeTab = ComposeComponent
    },
    logout() {
      simulateLogout()
    ...
    async postContent() {
      ...
      try {
        const response = await fetch('http://localhost/appsdev/backend/compose.php', {
          method: 'POST',
          headers: {
