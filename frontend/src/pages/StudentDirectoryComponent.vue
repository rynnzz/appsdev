...
export default {
  ...
  methods: {
    ...
    async viewDetails(user) {
      try {
        const response = await axios.get(`http://localhost/appsdev/backend/getUserDetails.php?id=${user.id_num}`);
    ...
    async fetchUsers() {
      try {
        const response = await axios.get('http://localhost/appsdev/backend/getUsersInfo.php');
        if (response.data.success) {
    ...
    async updateStatus(user) {
      try {
        const response = await axios.post('http://localhost/appsdev/backend/updateStatus.php', {
          id_num: user.id_num,
